...
\GIO{Which testing parameters?}
The overall approach of \toolname\ consists of three testing cycles: \GIO{The explanation of these 3 cycles is not super clear. Try to rephrase}
\begin{enumerate}
